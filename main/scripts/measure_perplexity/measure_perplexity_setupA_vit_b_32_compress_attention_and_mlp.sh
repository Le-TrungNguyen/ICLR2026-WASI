...
imagenet_link="/home/ids/lnguyen-23/imagenet/"
...
common_methods="--model.measure_perplexity_HOSVD_var True --model.count_attention True"
...
for i in "${!models[@]}"; do
  ...
  python trainer.py ${all_args} --model.backbone $model --logger.exp_name perplexity_test_var_0.4to0.9_attention_and_mlp --set_of_epsilons 0.4,0.5,0.6,0.7,0.8,0.9
done
